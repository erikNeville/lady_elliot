...
// Email
export const EMAIL = 'info@ladyelliotart.com';

// Social
export const socialStrings = {
  INSTAGRAM: 'https://www.instagram.com/lady.elliot.art/?hl=en',
  INSTAGRAM_TEXT: '@lady.elliot.art',
  FACEBOOK:
    'https://www.facebook.com/pages/category/Artist/Lady-Elliot-Art-110471590384822/',
  FACEBOOK_TEXT: 'Lady Elliot Art',
};
...
export const contactStrings = {
  ...
  EMAIL_CONTACT_TEXT_1:
    'If you have any general questions, would like to inquire about commissioning a painting, would like to purchase an existing painting or would like to collaborate on an event or showcase please direct your emails to ',
  EMAIL_CONTACT_TEXT_2:
    ' or fill out the form below. I look forward to hearing from you!',
  SOCIAL_MEDIA: 'Social Media',
  SOCIAL_MEDIA_TEXT_1:
    'If you would like to follow me on social media you can find me on Instagram ',
  SOCIAL_MEDIA_TEXT_2: ' or on my facebook page ',
};

// Commission screen
export const commissionStrings = {
  COMMISSION_TITLE: 'Commissions',
  COMMISSION_INQUERY: 'Can I commission a Lady Elliot painting?',
  COMMISSION_INQUERY_TEXT:
    'Yes you can! For commissioned paintings, you can specify custom canvas sizes, subject matter, and color palette choices. I am happy to work with you to bring your visions to life.',
  COMMISSION_PROCESS: 'The Commission Process',
  COMMISSION_PROCESS_TEXT_1:
...
export const eventStrings = {
  EVENTS_TITLE: 'Events & Showcases',
  EVENTS_CURRENT: 'Current Events',
  EVENTS_CURRENT_TEXT_1: '',
  EVENTS_ADDITIONAL_1:
    'For additional information please follow me on Instagram ',
  EVENTS_ADDITIONAL_2: ' or Facebook at ',
  EVENTS_UPCOMING: 'Upcoming Events & Showcases',
  EVENTS_UPCOMING_TEXT: '',
  EVENTS_PAST: 'Past Events & Showcases',
  EVENTS_PAST_TEXT: '',
};
...
export const pastEvents = [
  {
    year: '2020',
    location: 'The Maple Pub, Seattle WA',
    date: 'Winter 2020',
    description: 'Art Display',
  },
  {
    year: '2019',
    location: 'RAW Artist Holiday RAWk 2019, Seattle WA',
    date: 'Dec 11, 2020',
    description: 'Event',
  },
  {
    year: '2019',
    location: 'Latona Pub, Greenlake',
    date: 'Summer - Fall 2019',
    description: 'Art Display',
  },
  {
    year: '2019',
    location: 'Jellyfish Brewing Company, Georgetown',
    date: 'Spring 2019',
    description: 'Art Display',
  },
];
